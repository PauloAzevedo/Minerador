...
import br.com.ehrickwilliam.model.Comment_sample;
 ...
 * @author Erick
 */
public class JDialogImportantoComments extends javax.swing.JDialog {
            ...
            public void run() {
                ...
                while (flag == 0) {
                    try {
                        ...
                        Logger.getLogger(JDialogImportantoComments.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }.start();
